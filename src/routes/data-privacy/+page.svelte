<main>
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Allgemeine Hinweise</h3>
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Datenerfassung auf dieser Website</h3>
    <h4 class="mt-4 scroll-m-20 text-xl font-semibold tracking-tight">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h4 class="mt-4 scroll-m-20 text-xl font-semibold tracking-tight">Wie erfassen wir Ihre Daten?</h4>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h4 class="mt-4 scroll-m-20 text-xl font-semibold tracking-tight">Wof&uuml;r nutzen wir Ihre Daten?</h4>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu
        gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet
        werden.
    </p>
    <h4 class="mt-4 scroll-m-20 text-xl font-semibold tracking-tight">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <p class="leading-7 [&:not(:first-child)]:mt-6">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Externes Hosting</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <p class="leading-7 [&:not(:first-child)]:mt-6">Wir setzen folgende(n) Hoster ein:</p>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Cloudflare Inc., <br />
        101 Townsend St., San Francisco, <br />
        CA 94107, USA
    </p>
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Cloudflare</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Wir nutzen den Service &bdquo;Cloudflare&ldquo;. Anbieter ist die Cloudflare Inc., 101
        Townsend St., San Francisco, CA 94107, USA (im Folgenden &bdquo;Cloudflare&rdquo;).
    </p>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Cloudflare bietet ein weltweit verteiltes Content Delivery Network mit DNS an. Dabei wird
        technisch der Informationstransfer zwischen Ihrem Browser und unserer Website &uuml;ber das
        ...
        Servern und potenziell b&ouml;sartigem Datenverkehr aus dem Internet zu dienen. Hierbei kann
    ...
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Der Einsatz von Cloudflare beruht auf unserem berechtigten Interesse an einer m&ouml;glichst
    ...
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Weitere Informationen zum Thema Sicherheit und Datenschutz bei Cloudflare finden Sie hier: <a
        href="https://www.cloudflare.com/privacypolicy/"
        target="_blank"
        rel="noopener noreferrer">https://www.cloudflare.com/privacypolicy/</a
    >.
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Datenschutz</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Hinweis zur verantwortlichen Stelle</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser
        Website ist:</p>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        Elias Knodel<br />
        Eschenweg 6<br />
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Speicherdauer</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Allgemeine Hinweise zu den Rechtsgrundlagen der
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Hinweis zur Datenweitergabe in die USA und
        sonstige Drittstaaten</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Widerruf Ihrer Einwilligung zur
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Beschwerde&shy;recht bei der zust&auml;ndigen
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Recht auf
        Daten&shy;&uuml;bertrag&shy;barkeit</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Auskunft, L&ouml;schung und Berichtigung</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Recht auf Einschr&auml;nkung der
        Verarbeitung</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">
    ...
    <h3 class="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
    <p class="leading-7 [&:not(:first-child)]:mt-6">

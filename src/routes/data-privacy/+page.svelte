...
<div class="mx-auto max-w-screen-lg p-5">
    <main
        class="prose prose-invert prose-a:text-orange-light isolate h-full w-full rounded-xl border border-white/20 bg-black/50 px-4 py-2 backdrop-blur-md sm:px-10 sm:py-8"
    >
        ...
        <p>
            Details entnehmen Sie der Datenschutzerkl&auml;rung von Hetzner: <a
                ...
                target="_blank"
                rel="noopener
noreferrer">https://www.hetzner.com/de/legal/privacy-policy/</a
            >.
        </p>
        <p>
            Die Verwendung von Hetzner erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir
            haben ein berechtigtes Interesse an einer m&ouml;glichst zuverl&auml;ssigen Darstellung
            ...
            Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B.
        ...
        <p>E-Mail: contact@elias-knodel.de</p>
        <p>
        ...
        <p>
            ...
            auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.
